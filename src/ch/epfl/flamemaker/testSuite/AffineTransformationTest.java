...
public class AffineTransformationTest {
	...
	public void testNewTranslation() {
		...
		AffineTransformation matrice = AffineTransformation.newTranslation(42, 42);
	...
	public void testTranslationX() {
		double ref = 4;
		AffineTransformation matrice = new AffineTransformation(0, 0, 4, 0, 0, 0);
	...
	public void testTranslationY() {
		double ref = 4;
		AffineTransformation matrice = new AffineTransformation(0, 0, 0, 0, 0, 4);
